...
(1, 0, '#', 'SETTINGS', 'fas fa-fw fa-cogs', 18, 'Auth. Control List', 'publish'),
(3, 1, 'acl/groups/', 'GROUPS', 'fas fa-fw fa-tags', 3, 'Groups Authentifications', 'publish'),
(4, 1, 'acl/users/', 'USERS', 'fas fa-fw fa-users', 6, 'Users Application', 'publish'),
(7, 0, '#', 'Data Pelanggaran ', 'fas fa-fw fa-clipboard-list', 3, 'Data Pelanggaran ', 'publish'),
(2, 0, 'dashboard/', 'DASHBOARD', 'fas fa-fw fa-tachometer-alt', 1, 'Panel Dashboard', 'publish'),
(6, 0, '#', 'Data Pelanggar', 'fas fa-fw fa-user-times', 2, 'Data Pelanggar', 'publish'),
(5, 0, 'report/', 'REPORT', 'fas fa-fw fa-book', 21, 'Laporan arsip surat', 'draft');
...
(25, 'APP_NAME_LONG', 'Sistem Informasi Sidak Masker Banda Aceh', 'GENERAL', 'text'),
...
INSERT INTO `users` (`id`, `ip_address`, `username`, `password`, `salt`, `email`, `activation_code`, `forgotten_password_code`, `forgotten_password_time`, `remember_code`, `created_on`, `last_login`, `active`, `first_name`, `last_name`, `company`, `phone`, `instansi_id`, `golongan_id`) VALUES
(703, '', 'admin', '$2y$08$TU40ppT0845itWOkSaVU3O9D9SlPBKzzy49nbuVV9mSnusBWO2R1i', NULL, 'admin@gmail.com', '', NULL, NULL, NULL, NULL, 1589387759, 1, 'Adminis', 'trator', '', '', '', NULL);
...
--
ALTER TABLE `menus`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'this is ID for menus', AUTO_INCREMENT=89;
...
--
ALTER TABLE `users`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=704;

--
-- AUTO_INCREMENT for table `users_groups`
--
ALTER TABLE `users_groups`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=793;
COMMIT;
