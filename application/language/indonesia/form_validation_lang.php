...
$lang['isset'] = 'Bagian %s harus memilik nilai.';
...
$lang['regex_match'] = "Bagian %s tidak sesuai dengan format yang benar.";
$lang['matches'] = 'Bagian %s tidak sesuai dengan bagian %s.';
$lang['is_unique'] = "Bagian %s harus memuat isi yang unik.";
...
$lang['less_than'] = "Bagian %s harus memuat angka kurang dari %s.";
$lang['greater_than'] = "Bagian %s harus memuat angka lebih dari %s.";
